...
Live coding and prototyping environment. Shadertoy on steroids, but powered by Scheme for dynamically setting uniforms and other values. Dynamically set textures, variables, and other logic that affects the execution.
